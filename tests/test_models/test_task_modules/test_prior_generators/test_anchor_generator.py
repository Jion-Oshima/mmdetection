...
def test_standard_points_generator():
    from models.mmdetection.mmdet.models.task_modules import build_prior_generator
    ...
    # test_stride
    from models.mmdetection.mmdet.models.task_modules.prior_generators import MlvlPointGenerator
...
def test_sparse_prior():
    ...
    from models.mmdetection.mmdet.models.task_modules.prior_generators import AnchorGenerator
    ...
    # for ssd
    from models.mmdetection.mmdet.models.task_modules.prior_generators import SSDAnchorGenerator
    ...
    # for yolo
    from models.mmdetection.mmdet.models.task_modules.prior_generators import YOLOAnchorGenerator
    featmap_sizes = [(38, 38), (19, 19), (10, 10)]
    ...
    if torch.cuda.is_available():
        ...
        # for ssd
        from models.mmdetection.mmdet.models.task_modules.prior_generators import \
            SSDAnchorGenerator
        featmap_sizes = [(38, 38), (19, 19), (10, 10)]
        anchor_generator = SSDAnchorGenerator(
            scale_major=False,
...
def test_standard_anchor_generator():
    from models.mmdetection.mmdet.models.task_modules import build_anchor_generator
    anchor_generator_cfg = dict(
